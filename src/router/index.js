...
},
{
  ...
  path: '/user',
  component: Layout,
  redirect: '/user/merchant-info',
  meta: {
    title: '工厂设置',
    icon: 'setting',
    isSuperAdmin: true,
    hideOnBusinessStyle: ['aimingpian', 'noodles']
  },
  children: [
    // {
    ...
    // },
    {
      name: '商户信息',
      path: 'merchant-info',
      component: () => import('@/views/apifm-setting/merchant-info'),
      meta: {
        title: '商户信息',
        icon: 'setting',
        isSuperAdmin: true
    ...
    },
    {
      name: '推广团队',
      path: 'spread/teams',
      component: () => import('@/views/apifm-setting/spread'),
      meta: {
        title: '推广团队',
        icon: 'tuiguang',
        noKeepAlive: true,
    ...
    {
      name: '推广收入',
      path: 'centerUserCashLog/list',
      component: () => import('@/views/apifm-setting/centerUserCashLog'),
      meta: {
        title: '推广收入',
        icon: 'caiwu',
        isSuperAdmin: true
    ...
    },
    {
      ...
      component: () => import('@/views/apifm-setting/centerUserApi'),
      meta: {
        title: '模块管理',
        icon: 'mokuai',
        isSuperAdmin: true
    ...
    {
      name: '插件管理',
      path: 'pluginInfo/list',
      component: () => import('@/views/apifm-setting/pluginInfo'),
      meta: {
        title: '插件管理',
        icon: 'pluginInfo',
        noKeepAlive: true,
    ...
    },    
    {
      ...
      component: () => import('@/views/apifm-setting/centerUserResourceBundle'),
      meta: {
        title: '我的资源包',
        icon: 'ziyuan',
        isSuperAdmin: true
    ...
    },
    {
      name: '我的vip卡券',
      path: 'vipCard/list',
      component: () => import('@/views/apifm-setting/vipCard'),
      meta: {
        title: '我的vip卡券',
        icon: 'score',
        isSuperAdmin: true
    ...
    },
    {
      ...
      component: () => import('@/views/apifm-setting/centerUser'),
      meta: {
        title: '我的客户',
        icon: 'userList',
        isSuperAdmin: true
    ...
    },
    {
      name: '数据克隆',
      path: 'copyData/list',
      component: () => import('@/views/apifm-setting/copyData'),
      meta: {
        title: '数据克隆',
        icon: 'kelong',
        isSuperAdmin: true
...
},
{
  ...
  children: [
    ...
    {
      name: '存储包使用明细',
      path: 'apiExtDfs/resourceLog',
      component: () => import('@/views/apiExtDfs/resourceLog'),
      meta: {
        title: '存储包使用明细',
        icon: 'files'
      },
