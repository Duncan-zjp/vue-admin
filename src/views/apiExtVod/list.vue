  ...
  <div class="app-container">
    <el-collapse>
      <el-collapse-item>
        ...
        <div>1. 下架视频包功能，以后上传视频无需再购买视频包了；</div>
        <div>2. 购买存储流量包即可上传视频，按天为单位每天从你的存储流量包扣除你的视频总容量；</div>
        <div>3. 之前购买过视频包的用户，作为本次调整补偿，系统赠送一个</div>
        <div>4. 存储流量包使用情况，可在后台首页查看，如有疑问，请咨询客服；</div>
      </el-collapse-item>
    </el-collapse>
