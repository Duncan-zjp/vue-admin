  ...
  <div class="app-container">
    ...
    <el-form :rules="rules" ref="addEditPopForm" :model="pushData" :label-position="labelPosition" label-width="100px">
      <el-form-item label="店铺类型" prop="type">
        <el-col :span="12">
          <el-input v-model="pushData.type" clearable @keyup.enter.native="handleCreateSave" />
        </el-col>
        <el-col :span="10">&nbsp;&nbsp;&nbsp;自定义店铺类型，32个字符以内</el-col>
      </el-form-item>
      <el-form-item label="门店编号" prop="number">
        <el-col :span="12">
          <el-input v-model="pushData.number" clearable @keyup.enter.native="handleCreateSave" />
        </el-col>
        <el-col :span="10">&nbsp;&nbsp;&nbsp;达达、美团配送的时候需要填写</el-col>
      </el-form-item>
      <el-form-item label="生鲜配送" prop="expressType">
        <el-col :span="12">
          <el-input v-model="pushData.expressType" clearable @keyup.enter.native="handleCreateSave" />
        </el-col>
      ...
      <el-form-item label="营业时间" prop="openingHours">
        <el-input v-model="pushData.openingHours" clearable @keyup.enter.native="handleCreateSave" />
      </el-form-item>
      <el-form-item label="地址" prop="address">
        <el-input v-model="pushData.address" clearable @keyup.enter.native="handleCreateSave" />
      </el-form-item>
      <el-form-item label="联系电话" prop="linkPhone">
        <el-input v-model="pushData.linkPhone" clearable @keyup.enter.native="handleCreateSave" />
      </el-form-item>
      <el-form-item label="打印机编号" prop="printerSn">
        <el-col :span="6">
          <el-input v-model="pushData.printerSn" clearable @keyup.enter.native="handleCreateSave" />
        </el-col>
        <el-col :span="18" style="color:orange;padding-left:10px;">
          该店铺订单将从该打印机出单
        </el-col>
      </el-form-item>
      <el-form-item label="钉钉机器人" prop="dingtalkRobotToken">
        <el-col :span="6">
          <el-input v-model="pushData.dingtalkRobotToken" clearable @keyup.enter.native="handleCreateSave" />
        </el-col>
        <el-col :span="18" style="color:orange;padding-left:10px;">
          该店铺的订单，将通过钉钉机器人推送到钉钉群，<font style="color:red">开通钉钉推送插件后才有效</font>
        </el-col>
      </el-form-item>
      <el-form-item v-checkBuyedPlugin="[9]" label="店长" prop="bossUid">
        <el-col :span="6">
          <el-input v-model="pushData.bossUid" clearable @keyup.enter.native="handleCreateSave" />
        </el-col>
        <el-col :span="18" style="color:orange;padding-left:10px;">
      ...
      <el-form-item v-checkBuyedPlugin="[9]" label="业务员" prop="salesmanUid">
        <el-col :span="6">
          <el-input v-model="pushData.salesmanUid" clearable @keyup.enter.native="handleCreateSave" />
        </el-col>
        <el-col :span="18" style="color:orange;padding-left:10px;">
      ...
      <el-form-item label="店铺介绍" prop="introduce">
        <el-input v-model="pushData.introduce" type="textarea" clearable :rows="5" />
      </el-form-item>
      <el-form-item label="店铺特色" prop="characteristic">
        <el-input v-model="pushData.characteristic" type="textarea" clearable :rows="5" />
      </el-form-item>
      <el-form-item label="地图位置" prop="mapAddressSearch">
        <el-input v-model="pushData.mapAddressSearch" clearable
                  @keyup.native="codeAddress" placeholder="输入关键词搜索地图坐标" />
        <el-col :span="24">
          <div id="container">
          </div>
        </el-col>
      ...
      <el-form-item label="地图经度" prop="longitude">
        <el-col :span="4">
          <el-input v-model="pushData.longitude" clearable @keyup.enter.native="handleCreateSave" />
        </el-col>
      </el-form-item>
      <el-form-item label="地图纬度" prop="latitude">
        <el-col :span="4">
          <el-input v-model="pushData.latitude" clearable @keyup.enter.native="handleCreateSave" />
        </el-col>
      </el-form-item>
      <el-form-item label="排序" prop="paixu">
        <el-col :span="4">
          <el-input v-model.number="pushData.paixu" clearable @keyup.enter.native="handleCreateSave" />
        </el-col>
      </el-form-item>
      ...
      <el-form-item label="打折优惠信息" prop="activity">
        <el-input v-model="pushData.activity" type="textarea" clearable :rows="5" />
      </el-form-item>
      <el-form-item label="扩展属性">
        <div v-for="kv in kvList" v-bind:key="kv.k" style="padding-bottom:10px;">
          <el-col :span="4">
            <el-form-item>
              <el-input v-model="kv.k" @keyup.enter.native="handleCreateSave" />
            </el-form-item>
          </el-col>
          <el-col :span="1" align="center">:</el-col>  
          <el-col :span="4">
            <el-form-item>
              <el-input v-model="kv.v" @keyup.enter.native="handleCreateSave" />
            </el-form-item>
          </el-col>
          <el-col :span="14"> &nbsp;&nbsp;&nbsp;
