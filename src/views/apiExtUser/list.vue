<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-select v-model="searchData.levelId" clearable style="width: 200px" class="filter-item" placeholder="会员等级">
        <el-option label="全部" value="" />
      ...
      <el-input clearable style="width: 200px;" class="filter-item" v-model="searchData.wxOpenid" placeholder="微信openid" @keyup.enter.native="fetchData" />
...
export default {
  ...
  created() {
    ...
    this.fetchAllUserLevels()
  },
  activated() {
    this.fetchData()
  },
  methods: {
    async fetchAllUserLevels(){
      const res = await fetchAllUserLevels(1, 10000)
      if (res.code == 0) {
